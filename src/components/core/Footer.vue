            ...
            <v-row justify="start" class="">
              <v-col cols="12" md="3" lg="3" sm="3" class="py-2" >
                  ...
                  <div v-for="(item,i) in config.footerConfig['About']" :key="i">
                        <a :href="item.link" rel="noreferrer" :class="$vuetify.theme.dark?'darkThemeTextLink':'lightThemeTextLink'" class="google-font my-3" target="_blank" style="text-decoration: none;font-size:110%">Los asistentes de Voz más comunes para nuestro uso diario.</a><br>
                  </div>
              </v-col>
              ...
              <v-col cols="12" md="3" lg="3" sm="3" class="py-2" >
                  ...
                  <div v-for="(item,i) in config.footerConfig['Resources']" :key="i">
                        <a :href="item.link" rel="noreferrer" :class="$vuetify.theme.dark?'darkThemeTextLink':'lightThemeTextLink'" class="google-font my-3" target="_blank" style="text-decoration: none;font-size:110%">Un asistente virual está formado por dos componentes </a><br>
                  </div>
              </v-col>
